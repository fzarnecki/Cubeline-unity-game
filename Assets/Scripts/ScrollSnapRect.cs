// Borrowed script, all credits to respectful creator
...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    [SerializeField] private bool isSkinScroller;
    [SerializeField] private bool isUpgradeScroller;
    ...
    public void OnEndDrag(PointerEventData aEventData) {
        ...
        // displaying change of selection on the player itself
        if (isSkinScroller)
            skinUpgradeManager.ChangeSkin();
        else if (isUpgradeScroller)
            skinUpgradeManager.ChangeUpgrade();
    }
